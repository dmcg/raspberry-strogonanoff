...
class Test(unittest.TestCase):
    ...
    def test_encode_as_state_list(self):
        self.assertEqual([1], encode_as_state_list([0]))
        self.assertEqual([1, 1, 1], encode_as_state_list([1]))
        self.assertEqual([1, 0, 0, 0], encode_as_state_list([0, 1]))
        self.assertEqual([1, 1, 1, 0], encode_as_state_list([1, 0]))
    ...
    def test_encode_packet(self):
        ...
        self.assertEquals(preamble + [1] + [1, 0, 0, 0] + postamble, encode_packet([0, 1]))
